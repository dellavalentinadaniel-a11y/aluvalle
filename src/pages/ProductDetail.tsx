  ...
  if (!product) {
    return (
      <div className="pt-40 pb-20 text-center min-h-screen bg-[#0b0e12]">
        <h1 className="text-[#a0d87a] text-9xl font-black opacity-10 font-headline leading-none">
          404
        </h1>
        <h2 className="text-[#e1e2e8] text-4xl font-headline font-bold uppercase -mt-12 mb-8 tracking-tighter">
          Producto no encontrado
        </h2>
        <Link
          to="/sistemas/ventanas-y-puertas"
          className="bg-[#a0d87a] text-[#0b0e12] px-8 py-3 font-bold uppercase text-xs tracking-widest hover:bg-white transition-colors"
        >
          Volver al Catálogo
        </Link>
      </div>
    ...
    <div className="bg-[#0b0e12] min-h-screen">
          ...
          <div className="flex flex-col items-start gap-6">
            ...
            <div className="flex flex-col">
              <h1 className="font-headline text-4xl sm:text-6xl md:text-[8rem] font-bold text-[#e1e2e8] leading-none uppercase tracking-tighter">
                ...
                <br />
                <span className="text-[#94979e] pl-0 sm:pl-20 md:pl-20 block sm:inline">
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          <div className="flex flex-col">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-2 gap-px bg-[#323539]/20 border border-[#323539]/20 p-px">
              {product.specs.map((spec) => (
                <div
                  key={spec.label}
                  className="bg-[#111417] p-4 sm:p-8 flex flex-col items-center text-center hover:bg-[#191c20] transition-colors group"
                >
                  <span className="material-symbols-outlined text-[#a0d87a]/40 mb-2 sm:mb-4 group-hover:text-[#a0d87a] transition-colors">
                    {spec.icon}
                  </span>
                  <span className="text-[#94979e] text-[9px] sm:text-[10px] uppercase tracking-widest mb-1">
                    {spec.label}
                  </span>
                  <span className="text-[#e1e2e8] font-bold text-xs sm:text-sm tracking-tight">
                    {spec.value}
                  </span>
                </div>
              ))}
          ...
          <div className="flex flex-col gap-8 bg-[#191c20]/40 backdrop-blur-md border border-[#323539]/30 p-8 sm:p-12 lg:p-16">
            <h3 className="font-headline text-2xl font-bold text-[#e1e2e8] uppercase mb-4">
            ...
            <div className="space-y-10">
              {product.features.map((feature) => (
                <div key={feature.title} className="flex gap-6 group">
                  ...
                  <div>
                    <h4 className="text-[#e1e2e8] font-bold uppercase text-sm mb-2 tracking-wide">
                      {feature.title}
                    </h4>
        ...
        <section className="max-w-7xl mx-auto px-6 pb-24">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-8">
            <div className="max-w-2xl">
              <h2 className="font-headline text-3xl md:text-5xl font-bold text-[#e1e2e8] uppercase mb-4">
                Catálogo de Perfiles
              </h2>
              <p className="text-[#94979e] text-sm md:text-base leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                ...
                <div className="text-left">
                  <p className="text-[10px] uppercase tracking-widest text-[#a0d87a] group-hover:text-[#0b0e12] font-bold">
                    Ensayos Técnicos
                  </p>
          ...
          <div className="space-y-4">
            <div className="border border-[#323539]/30 bg-[#111417]/50 overflow-hidden rounded-2xl">
              ...
              >
                <div>
                  <h3 className="text-xl sm:text-2xl font-bold text-[#e1e2e8] uppercase">
                    Mónaco Estándar
                  </h3>
                  <p className="text-[#94979e] text-xs uppercase tracking-widest mt-1">
                    Perfiles base para tipologías corredizas y batientes
                  </p>
                </div>
                <ChevronDown
                  className={`w-6 h-6 text-[#a0d87a] transition-transform duration-300 ${activeAccordion === 'monaco-standard' ? 'rotate-180' : ''}`}
                />
              </button>
            ...
            <div className="border border-[#323539]/30 bg-[#111417]/50 overflow-hidden rounded-2xl">
              ...
              >
                ...
                <ChevronDown
                  className={`w-6 h-6 text-[#a0d87a] transition-transform duration-300 ${activeAccordion === 'monaco-top' ? 'rotate-180' : ''}`}
                />
              </button>
          ...
          <section className="max-w-7xl mx-auto px-6 pb-24">
            <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-8">
              ...
              {product.slug === 'linea-tradicional' && (
                ...
                >
                  <div className="bg-[#a0d87a] p-2 rounded-lg group-hover:bg-[#0b0e12] transition-colors">
                    <FileText className="w-5 h-5 text-[#0b0e12] group-hover:text-[#a0d87a]" />
                  </div>
                  <div className="text-left">
                    <p className="text-[10px] uppercase tracking-widest text-[#a0d87a] group-hover:text-[#0b0e12] font-bold">
      ...
      <section className="max-w-7xl mx-auto px-6 py-32 border-t border-[#323539]/20">
        <div className="flex flex-col items-center gap-12">
          <div className="text-center max-w-2xl">
            <h2 className="font-headline text-4xl font-black text-[#e1e2e8] uppercase mb-4">
              Documentación Especializada
            </h2>
            <p className="font-body text-[#94979e] text-sm">
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-8 w-full">
            {product.downloads.map((dl) => (
              ...
              >
                ...
                <div>
                  <h4 className="text-[#e1e2e8] font-bold uppercase text-xs tracking-widest mb-1">
                    {dl.label}
                  </h4>
      ...
      <section className="bg-[#a0d87a] text-[#0b0e12] py-20">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <Link
            to="/contact"
            className="bg-[#0b0e12] text-white px-12 py-5 font-bold uppercase text-xs tracking-[0.3em] hover:bg-white hover:text-black transition-all shadow-2xl"
          >
            Consultar Ahora
          </Link>
        </div>
