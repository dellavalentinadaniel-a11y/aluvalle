    ...
    <div className="pt-24 pb-20">
      ...
      <section className="max-w-7xl mx-auto px-6 mb-16 pt-12">
        <div className="flex flex-col md:flex-row items-end justify-between gap-8 mb-12">
          <div className="max-w-2xl">
            ...
            <h1 className="font-headline text-5xl md:text-7xl font-bold tracking-tight text-[#e1e2e8] leading-none uppercase">
              Sistemas<br/>
              <span className="text-[#94979e]">Complementarios</span>
            </h1>
          </div>
          <div className="hidden md:block pb-2">
            <p className="font-body text-[#94979e] max-w-xs text-sm leading-relaxed border-l border-[#323539]/50 pl-6">
              Integre soluciones en aluminio para todas las terminaciones de su obra. Máxima calidad en funcionalidad y diseño interior.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-4 mb-20 border-b border-[#323539]/20 pb-4">
          ...
          <button className="px-5 py-2 bg-[#111417] border border-[#323539]/30 text-[#94979e] rounded-full text-xs font-bold uppercase tracking-wider hover:bg-[#191c20] hover:text-[#e1e2e8] transition-colors">Interiores</button>
          <button className="px-5 py-2 bg-[#111417] border border-[#323539]/30 text-[#94979e] rounded-full text-xs font-bold uppercase tracking-wider hover:bg-[#191c20] hover:text-[#e1e2e8] transition-colors">Exteriores</button>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 mt-32">
        <div className="bg-[#191c20] border border-[#323539]/20 p-12 md:p-20 relative overflow-hidden">
          <div className="relative z-10 max-w-xl">
            <h2 className="font-headline text-4xl font-bold text-[#e1e2e8] uppercase mb-6 leading-tight">Terminaciones<br/>Profesionales</h2>
            <p className="font-body text-[#94979e] mb-10 text-sm leading-relaxed">
              Consulta especificaciones y manuales de perfiles para mamparas, barandas, frentes de placard y cortinas de aluminio.
            </p>
