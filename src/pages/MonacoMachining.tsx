...
export default function MonacoMachining() {
  ...
  const tools = [
    { title: 'Punzonadora Mónaco', description: 'Realiza todos los calados necesarios para la línea (desagües, cierres, encuadres).', icon: Wrench },
    { title: 'Fresadora Frontal', description: 'Para el mecanizado de los travesaños y encuentros de marco.', icon: Settings },
    { title: 'Matríz Neumática', description: 'Accionamiento por pedal para alta producción en serie.', icon: Wrench },
  ];
  ...
  const operations = [
    { 
      ...
      details: 'Utilice siempre discos de tungsteno con refrigeración para asegurar cortes limpios.'
    },
    { 
    ...
    <div className="bg-[#0b0e12] min-h-screen pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 mb-20">
          <div>
            <h1 className="font-headline text-5xl md:text-7xl font-bold text-[#e1e2e8] uppercase leading-none tracking-tighter mb-4">
              Mecanizados<br/>
              <span className="text-[#a0d87a]">Mónaco</span>
            </h1>
            <p className="text-[#94979e] max-w-xl text-lg">
              Guía técnica para el armado de la Línea Mónaco. Optimización de procesos y herramental necesario para centros de producción.
            </p>
          </div>
          <a 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
          {tools.map((t, i) => (
            <div key={i} className="bg-[#111417] border border-[#323539]/30 p-10 group hover:border-[#a0d87a]/50 transition-all">
              <t.icon className="w-12 h-12 text-[#a0d87a] mb-6 group-hover:scale-110 transition-transform" />
              <h3 className="text-[#e1e2e8] font-bold uppercase text-lg mb-3 tracking-wide">{t.title}</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          <div>
            ...
            <div className="space-y-12">
              {operations.map((op, i) => (
                <div key={i} className="relative pl-12 border-l border-[#323539]/30 hover:border-[#a0d87a]/50 transition-colors py-2">
                  <div className="absolute left-[-5px] top-6 w-[9px] h-[9px] bg-[#a0d87a] rounded-full shadow-[0_0_10px_rgba(160,216,122,0.5)]" />
                  <h4 className="text-[#e1e2e8] font-bold uppercase mb-2 tracking-tight">{op.title}</h4>
                  ...
                  <div className="bg-[#191c20] p-4 flex items-start gap-3 border border-[#323539]/20">
                    ...
                    <p className="text-[#94979e] text-[11px] leading-relaxed italic">{op.details}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div>
            <div className="bg-[#111417] border border-[#323539]/30 p-12 sticky top-40">
              <h2 className="font-headline text-3xl font-bold text-white uppercase mb-8">Requisitos de Planta</h2>
              <div className="space-y-8">
                <div className="flex gap-6">
                  ...
                  <div>
                    <h4 className="text-[#e1e2e8] font-bold uppercase text-sm mb-1 tracking-wider">Espacio Recomendado</h4>
                    <p className="text-[#94979e] text-sm leading-relaxed">Área mínima de 40m² para manipulación de perfiles de hasta 6 metros de largo.</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  <div className="bg-[#191c20] p-4 rounded-xl">
                  ...
                  <div>
                    <h4 className="text-[#e1e2e8] font-bold uppercase text-sm mb-1 tracking-wider">Planillas de Corte</h4>
                    <p className="text-[#94979e] text-sm leading-relaxed">Disponibles en formato XLS para software de optimización (Cortamás, Softal, etc).</p>
                  </div>
                </div>
              </div>

              <div className="mt-12 pt-12 border-t border-[#323539]/20">
                <p className="text-xs text-[#94979e] leading-relaxed mb-6 uppercase tracking-widest font-bold">Consulte por Capacitación</p>
                <button className="w-full bg-[#323539] hover:bg-[#a0d87a] hover:text-[#0b0e12] text-white font-bold py-4 uppercase text-[10px] tracking-[0.2em] transition-all">
