    ...
    <div className="bg-background transition-colors duration-500">
      ...
      <section className="relative h-screen flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 w-full">
          ...
          >
            PRECISIÓN <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary/60">SIN LÍMITES.</span>
          </motion.h1>
          <motion.p 
          ...
          >
             <Link to="/sistemas/ventanas-y-puertas" className="bg-primary text-on-primary px-10 py-5 rounded-full font-bold uppercase tracking-widest hover:brightness-110 transition-all transform hover:scale-105">
                Ver Catálogo
             </Link>
             <Link to="/proyectos" className="border border-primary text-primary px-10 py-5 rounded-full font-bold uppercase tracking-widest hover:bg-primary hover:text-on-primary transition-all transform hover:scale-105">
                Proyectos
             </Link>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="absolute bottom-10 left-10">
                <span className="bg-primary text-on-primary text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-tighter mb-4 inline-block">Logística</span>
      ...
      <section className="py-40 bg-background relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl md:text-6xl font-bold text-on-surface mb-8 tracking-tight">El estándar de oro en perfiles arquitectónicos</h2>
          ...
          <Link to="/oficina-tecnica" className="text-primary font-bold uppercase tracking-widest border-b-2 border-primary pb-2 hover:opacity-70 transition-opacity">
