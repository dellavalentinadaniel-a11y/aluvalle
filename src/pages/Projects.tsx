...
const projects = [
  {
    ...
    description: 'Envolvente de alta performance con control solar activo para optimización energética.'
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description: 'Integración de sistemas de control solar para el clima árido de la precordillera.'
  },
  {
    id: 4,
    ...
    image: 'https://images.unsplash.com/photo-1428366890462-dd4baecf492b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
  ...
  return (
    <div className="min-h-screen pt-24 pb-20 bg-[#0b0e12]">
      <section className="max-w-7xl mx-auto px-4 mb-20">
        ...
        >
          Nuestros sistemas visten la arquitectura más exigente de la región. Explore cómo la precisión de Aluvalle se materializa en proyectos de escala internacional.
        </motion.p>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 mt-32 text-center">
        <div className="bg-[#161a1f] border border-gray-800 p-16 rounded-[3rem] relative overflow-hidden">
          <div className="absolute top-0 right-0 p-12 pointer-events-none opacity-10">
            <span className="material-symbols-outlined text-[10rem] text-[#a0d87a]">architecture</span>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">¿Tiene un proyecto en mente?</h2>
          <p className="text-gray-400 max-w-xl mx-auto mb-10">
            Trabajemos juntos para especificar el sistema que mejor se adapte a sus requerimientos técnicos y de diseño.
          </p>
