      ...
      <div className="relative z-10">
        <section className="max-w-7xl mx-auto px-4 mb-20">
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-bold text-on-surface mb-8 tracking-tight uppercase"
          >
            Obras <span className="text-primary">Emblemáticas</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          {projects.map((project, idx) => (
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-10 flex flex-col justify-end translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                ...
                <p className="text-white/80 transform opacity-0 group-hover:opacity-100 transition-all duration-500 delay-100 translate-y-4 group-hover:translate-y-0 text-sm">
                  {project.description}
                </p>
        ...
        <section className="max-w-7xl mx-auto px-4 mt-32 text-center pb-20">
          <div className="bg-surface-variant/10 backdrop-blur-md border border-outline/20 p-16 rounded-[3rem] relative overflow-hidden shadow-2xl">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-on-surface mb-6 uppercase">
            ...
            <button className="bg-primary text-on-primary px-10 py-5 rounded-full font-bold uppercase tracking-widest hover:brightness-110 transition-all transform hover:scale-105 shadow-xl">
