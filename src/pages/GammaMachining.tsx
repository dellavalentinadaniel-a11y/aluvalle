import { Settings, Scissors, Info, Download, ArrowLeft, Ruler, Wrench, Wind, ChevronLeft, ChevronRight } from 'lucide-react';
          ...
          <div ref={techCarouselRef} className="flex gap-6 overflow-x-auto snap-x snap-mandatory pb-8 -mx-6 px-6 hide-scrollbar scroll-smooth">
            {technicalTools.map((t, i) => (
              <AffiliateProductCard 
                key={i} 
                product={t} 
                className="w-[85%] md:w-[calc(50%-0.75rem)] lg:w-[calc(33.333%-1rem)] flex-shrink-0" 
              />
            ))}
          </div>
